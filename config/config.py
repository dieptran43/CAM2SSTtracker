...
def init_test_mot17():
    ...
    config['mot_root'] = '/local/b/cam2/data/HumanBehavior/MOT17'
    config['save_folder'] = '/local/b/cam2/data/HumanBehavior/MOT17Results'
    config['log_folder'] = '/local/b/cam2/data/HumanBehavior/MOT17log'
    config['batch_size'] = 1
